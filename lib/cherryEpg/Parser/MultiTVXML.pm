package cherryEpg::Parser::MultiTVXML;
...
All found language variants are parsed and returned to the ingester.
=cut
...
sub parse {
  ...
  my $handler = MultiTVXMLHandler->new();
...
This software is copyright (c) 2021-2025 by Bojan Ramšak
